    ...
    <div class="text-center alig" id="respon">
        ...
        <div class=" text-center">
            <form class="Text-center" action="admin/Participants/action.php" id="demo-form"  method="POST" >
                ...
                <button data-sitekey="6LezUQwcAAAAAHoAJxY5ePqjpT0FXWO_7Ygp6lhp"  type="submit" data-name="btn-ajout" class="btn g-recaptcha btn-g <?php echo($inscription['bouton']);?>   z btn-lg text-uppercase"    
                data-callback='onSubmit'><?= $inscription['boutontext']?></button>
                </div>
            </form>
        </div>
